...
function blacksilver_function_scripts_styles() {
	...
	wp_enqueue_style( 'blacksilver-MainStyle', get_stylesheet_uri(), 'false', '2.0' );
	...
	wp_enqueue_script( 'blacksilver-common', get_template_directory_uri() . '/js/common.js', array( 'jquery' ), '4.0', true );
