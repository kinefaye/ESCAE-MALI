...
<div class="entry-content author-info">
	...
	<?php
	$author_publishedby = blacksilver_get_option_data( 'author_publishedby' );
	if ( '' !== $author_publishedby ) {
		echo esc_html( $author_publishedby );
	} else {
		esc_html_e( 'Published by', 'blacksilver' );
	}
	?>
	</h2>
			...
			<div class="autho-linked-button">
				<a href="<?php echo esc_url( get_author_posts_url( get_the_author_meta( 'ID' ) ) ); ?>" rel="author">
					<div class="mtheme-button">
						<?php
						$author_postsby = blacksilver_get_option_data( 'author_postsby' );
						if ( '' !== $author_postsby ) {
